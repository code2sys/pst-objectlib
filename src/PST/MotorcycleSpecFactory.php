...
class MotorcycleSpecFactory extends AbstractFactory
{
    public function __construct($dbh, $master_factory, $obj = "PST\\MotorcycleSpecObject", $table = "motorcyclespec", $id = "motorcyclespec_id")
    {
        ...
        $this->_datacols = array(
            "version_number", "value", "feature_name", "attribute_name", "type", "external_package_id", "motorcycle_id", "final_value", "override", "source", "hidden", "crs_attribute_id", "ordinal", "motorcyclespecgroup_id", "hang_tag"
        );
    }
